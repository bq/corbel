...
public class ResmiPutRem extends AbstractResmiRem {
    ...
    public Response relation(String type, ResourceId id, String relation, RequestParameters<RelationParameters> parameters,
        ...
        try {
            ...
            Optional<Response> possibleResponse = entity.filter(requestEntity -> requestEntity.has("_order")).map(requestEntity -> {
                resmiService.moveRelation(resourceUri, RelationMoveOperation.create(requestEntity.get("_order").getAsString()));
                return noContent();
            });
            ...
            resmiService.createRelation(resourceUri, entity);
            return created();
