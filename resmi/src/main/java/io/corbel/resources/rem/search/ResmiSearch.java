...
public interface ResmiSearch {
    ...
    boolean upsertResmiIndex(String domain, String name);

    boolean upsertResmiIndex(String domain, String name, String settings, String defaultMapping);

    void setupMapping(String domain, String name, String mapping);
