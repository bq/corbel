...
public class ResmiGetRemTest extends ResmiRemTest {
    ...
    public void testGetResource() {
        ...
        when(requestParametersResourceParametersMock.getRequestDomain()).thenReturn(DOMAIN);
    ...
    public void testGetCollection() throws BadConfigurationException {
        ...
        when(requestParametersCollectionParametersMock.getRequestDomain()).thenReturn(DOMAIN);
    ...
    public void testGetRelation() throws BadConfigurationException {
        ...
        when(requestParametersRelationParametersMock.getRequestDomain()).thenReturn(DOMAIN);
