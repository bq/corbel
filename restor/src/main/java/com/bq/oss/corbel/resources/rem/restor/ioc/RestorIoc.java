...
@Import({ConfigurationIoC.class}) public class RestorIoc {
    ...
    private static final String IMAGE_CACHE_COLLECTION_DEFAULT = "image:ImageCache";
    ...
    public RestorDao getRestorDao() {
        return new S3RestorDao(getKeyNormalizer(), getAmazonS3Client(), env.getProperty("restor.s3.bucket"), env.getProperty(
                "restor.s3.retries", Integer.class, AMAZONS3_RETRY_DEFAULT), env.getProperty("image.cache.collection", String.class,
                IMAGE_CACHE_COLLECTION_DEFAULT));
    }
