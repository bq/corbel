...
m.fasterxml.jackson.datatype.jsr310.JSR310Module;

@Configuration @Import({ConfigurationIoC.class, DropwizardIoc.class, TokenIoc.class, AuthorizationIoc.class, CorsIoc.class,
        EventBusListeningIoc.class, RabbitMQHealthCheckIoc.class, CommonFiltersIoc.class}) @ComponentScan({
        "com.bq.oss.corbel.evci.eworker.plugin", "com.bqreaders.silkroad.evci.eworker.plugin"}) public class EvciIoc extends
        AbstractRabbitMQConfiguration {
