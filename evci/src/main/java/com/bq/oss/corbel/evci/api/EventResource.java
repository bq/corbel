...
public class EventResource {
	...
	public Response registerFormParamsEvent(@PathParam("type") String type, Form params, @Context Request request) {
		Response response = Response.fromResponse(registerJsonEvent(type, getNodeParams(params)))
				.type(MediaType.TEXT_PLAIN_TYPE).entity("[accepted]").build();
		return response;
	}
