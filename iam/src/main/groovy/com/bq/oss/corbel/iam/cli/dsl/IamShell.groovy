...
class IamShell {
    ...
    public IamShell(ClientRepository clientRepository, ScopeRepository scopeRepository, UserRepository userRepository,
                    DomainRepository domainRepository, String iamUri, IdentityRepository identityRepository, GroupService groupService) {
    ...
    def createGroup(groupFields) {
        ...
        assert groupFields.scopes: 'scopes are required'

        groupService.create(new Group(null, groupFields.name, groupFields.domain, groupFields.scopes))
    }

    @Description('Update a users group')
    def updateGroup(groupFields) {
        assert groupFields.id: 'id is required'

        groupService.update(groupFields.id, new Group(groupFields.id, groupFields.name, groupFields.domain, groupFields.scopes))
    }
    ...
    @Description('Get a users group')
    def getGroup(String id) {
        groupService.get(id)
    }
