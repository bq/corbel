...
public class DefaultAuthorizationService implements AuthorizationService {
    ...
    private TokenGrant grantAccess(AuthorizationRequestContext context, Optional<User> userOptional) throws UnauthorizedException {
        ...
        Set<Scope> firstLevelScopes = scopeService.getFirstLevelAllowedScopes(context);
        ...
        if (userOptional.isPresent()) {
            ...
            storeUserToken(tokenGrant, user, context.getDeviceId(), scopeService.getEveryLevelAllowedScopes(context));
