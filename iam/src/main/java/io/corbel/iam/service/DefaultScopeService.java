...
public class DefaultScopeService implements ScopeService {
    ...
    @Override
    public Set<Scope> getFirstLevelScopes(AuthorizationRequestContext context){
        return getScopes(context, false);
    }

    @Override
    public Set<Scope> getAnyLevelScopes(AuthorizationRequestContext context){
        return getScopes(context, true);
    }

    private Set<Scope> getScopes(AuthorizationRequestContext context, boolean includeChildren) {
