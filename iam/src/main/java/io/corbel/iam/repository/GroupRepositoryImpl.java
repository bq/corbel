...
public class GroupRepositoryImpl extends HasScopesRepositoryBase<Group, String> implements GroupRepositoryCustom {
    ...
    @Override
    public boolean exists(String name, String domainId) {
        return MongoCommonOperations.exists(mongo, ImmutableMap.of(FIELD_NAME, name, FIELD_DOMAIN, domainId), Group.class);
    }
