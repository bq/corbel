...
import com.bq.corbel.iam.auth.provider.AuthorizationProviderFactory;
...
@RunWith(MockitoJUnitRunner.class) public class DefaultAuthorizationServiceTest {
    ...
    private com.bq.corbel.lib.token.TokenGrant tokenGrant;
    ...
    public void setUp() {
        ...
        tokenGrant = new com.bq.corbel.lib.token.TokenGrant(TEST_TOKEN, TEST_EXPIRATION);
