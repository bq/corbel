...
import com.bq.corbel.iam.model.GrantType;
import com.bq.corbel.iam.model.TokenGrant;
import com.bq.corbel.iam.service.AuthorizationService;
import com.bq.corbel.iam.service.UpgradeTokenService;
...
public class TokenResourceTest {
    ...
    private void checkErrorResponse(Response response, int status, String expectedMessage) {
        ...
        assertThat(response.getMediaType()).isEqualTo(MediaType.APPLICATION_JSON_TYPE);
        com.bq.corbel.lib.ws.model.Error error = response.readEntity(com.bq.corbel.lib.ws.model.Error.class);
