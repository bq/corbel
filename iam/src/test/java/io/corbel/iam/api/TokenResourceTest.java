...
public class TokenResourceTest {
    ...
    private static final String BAD_SYSTEM_CLOCK = "bad_system_clock";
    ...
    public void testPostReturnTokenOk() throws SignatureException, UnauthorizedException, MissingOAuthParamsException,
            OauthServerConnectionException, MissingBasicParamsException, BadSystemClockException {
    ...
    public void testPostBadSystemClock() throws SignatureException, UnauthorizedException, MissingOAuthParamsException,
            OauthServerConnectionException, MissingBasicParamsException, BadSystemClockException {
        when(authorizationServiceMock.authorize(TEST_ASSERTION)).thenThrow(new BadSystemClockException());
        ...
        checkErrorResponse(response, 401, BAD_SYSTEM_CLOCK);
    }
    ...
    @Test
    public void testGetIsAuthenticated() throws UnauthorizedException, MissingOAuthParamsException, OauthServerConnectionException, BadSystemClockException {
        TokenGrant testTokenGrant = new TokenGrant(TEST_TOKEN, 1, REFRESH_TOKEN);
    ...
    @Test
    public void testGetInvalidGrantType() throws UnauthorizedException, MissingOAuthParamsException, OauthServerConnectionException, BadSystemClockException {
        TokenGrant testTokenGrant = new TokenGrant(TEST_TOKEN, 1, REFRESH_TOKEN);
        when(authorizationServiceMock.authorize(Mockito.eq(TEST_ASSERTION), Mockito.any())).thenReturn(testTokenGrant);
    ...
    @Test
    public void testGetMissingGrantType() throws UnauthorizedException, MissingOAuthParamsException, OauthServerConnectionException, BadSystemClockException {
        TokenGrant testTokenGrant = new TokenGrant(TEST_TOKEN, 1, REFRESH_TOKEN);
        when(authorizationServiceMock.authorize(Mockito.eq(TEST_ASSERTION), Mockito.any())).thenReturn(testTokenGrant);
    ...
    @Test
    public void testGetMissingAssertion() throws UnauthorizedException, MissingOAuthParamsException, OauthServerConnectionException, BadSystemClockException {
        TokenGrant testTokenGrant = new TokenGrant(TEST_TOKEN, 1, REFRESH_TOKEN);
        when(authorizationServiceMock.authorize(Mockito.eq(TEST_ASSERTION), Mockito.any())).thenReturn(testTokenGrant);
    ...
    public void testGetState() throws UnauthorizedException, MissingOAuthParamsException, UnsupportedEncodingException,
            OauthServerConnectionException, BadSystemClockException {
        TokenGrant testTokenGrant = new TokenGrant(TEST_TOKEN, 1, REFRESH_TOKEN);
        when(authorizationServiceMock.authorize(Mockito.eq(TEST_ASSERTION), Mockito.any())).thenReturn(testTokenGrant);
