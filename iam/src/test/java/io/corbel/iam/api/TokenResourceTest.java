...
public class TokenResourceTest {
    ...
    private static final String SLOW_CLIENT_SYSTEM_CLOCK = "slow_client_system_clock";
    ...
    public void testPostBadSystemClock() throws SignatureException, UnauthorizedException, MissingOAuthParamsException,
            OauthServerConnectionException, MissingBasicParamsException, IllegalExpireTimeException {
        when(authorizationServiceMock.authorize(TEST_ASSERTION)).thenThrow(new IllegalExpireTimeException());
        ...
        checkErrorResponse(response, 401, SLOW_CLIENT_SYSTEM_CLOCK);
    }
