...
public class UserResourceTest extends UserResourceTestBase {
    ...
    public void testGetMeSession() {
        ...
        Scope scope1 = new Scope("id1", null, null, null, null, null);
        Scope scope2 = new Scope("id2", null, null, null, null, null);
        Set<Scope> scopes = new HashSet<>();
        scopes.add(scope1);
        scopes.add(scope2);
        userToken.setScopes(scopes);

        Set<String> scopesResponse = new HashSet<>();
        scopesResponse.add("id1");
        scopesResponse.add("id2");
        ...
        UserTokenResponse userTokenResponse = response.readEntity(UserTokenResponse.class);
        assertThat(userTokenResponse.getScopes()).isEqualTo(scopesResponse);
