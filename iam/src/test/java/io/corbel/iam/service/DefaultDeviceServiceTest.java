...
@RunWith(MockitoJUnitRunner.class) public class DefaultDeviceServiceTest {
    ...
    public void testGetDeviceByIdAndUserId() {
        when(deviceRepositoryMock.findByIdAndUserId(anyString(), eq(TEST_USER_ID))).thenReturn(deviceMock);
    ...
    public void testDeleteByIdAndUserId() {
        when(deviceRepositoryMock.deleteByIdAndUserId(anyString(), eq(TEST_USER_ID))).thenReturn(1L);
    ...
    public void testDeleteByIdAndUserIdNotExist() {
        when(deviceRepositoryMock.deleteByIdAndUserId(anyString(), eq(TEST_USER_ID))).thenReturn(0L);
