...
public interface AclResourcesService {
    ...
    boolean isAuthorized(TokenInfo tokenInfo, String type, ResourceId resourceId, AclPermission operation) throws AclFieldNotPresentException;
    ...
    Optional<JsonObject> getResourceIfIsAuthorized(TokenInfo tokenInfo, String type, ResourceId resourceId, AclPermission operation) throws AclFieldNotPresentException;
