...
import io.corbel.resources.cli.dsl.AclShell;
...
@Component public class RemAclPlugin extends RemPlugin {
    ...
    @Autowired private AclShell aclShell;
    ...
    protected void console() {
        init();
        aclShell.setEventBus(context.getBean(EventBus.class));
        aclShell.setAclAdminCollection(aclConfigurationCollection);
    }
