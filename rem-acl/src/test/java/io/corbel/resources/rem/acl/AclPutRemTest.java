...
@RunWith(MockitoJUnitRunner.class) public class AclPutRemTest {
    ...
    public void setUp() throws Exception {
        ...
        rem = new AclPutRem(aclResourcesService, Collections.singletonList(getRem), ACL_CONFIGURATION_COLLECTION);
    ...
    public void testUpdateResourceObject() {
        ...
        when(aclResourcesService.getResourceIfIsAuthorized(eq(OPT_USER_ID), any(), eq(TYPE), eq(RESOURCE_ID), eq(AclPermission.WRITE)))
    ...
    public void testPutRelation() throws IOException {
        ...
        when(aclResourcesService.isAuthorized(eq(OPT_USER_ID), any(), eq(TYPE), eq(resourceId), eq(AclPermission.WRITE))).thenReturn(true);
