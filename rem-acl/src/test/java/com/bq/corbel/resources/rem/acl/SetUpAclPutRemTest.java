...
import static com.bq.corbel.resources.rem.acl.AclTestUtils.getEntity;
import static com.bq.corbel.resources.rem.utils.AclUtils.buildMessage;
...
@RunWith(MockitoJUnitRunner.class) public class SetUpAclPutRemTest {
    ...
    private com.bq.corbel.lib.ws.model.Error getError(Response response) {
