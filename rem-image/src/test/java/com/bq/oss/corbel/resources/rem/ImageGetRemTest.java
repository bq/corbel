...
public class ImageGetRemTest {
    ...
    public void imageFormatTest() throws IOException, ImageOperationsException, InterruptedException, IM4JavaException {
        ...
        verify(imageOperationsService).applyConversionWitFormat(anyListOf(ImageOperationDescription.class),
                eq(entity), any(TeeOutputStream.class), any(String.class));
        verify(imageOperationsService, never()).applyConversion(anyListOf(ImageOperationDescription.class),
