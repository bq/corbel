...
@RunWith(MockitoJUnitRunner.class) public class ImageGetRemTest {
    ...
    public void resourceWidthTest() throws IOException, InterruptedException, IM4JavaException, ImageOperationsException {
        ...
        verify(imageOperationsService).applyConversion(eq(Collections.singletonList(Arrays.asList("resizeWidth", "250"))), eq(entity),
    ...
    public void resourceHeightTest() throws IOException, InterruptedException, IM4JavaException, ImageOperationsException {
        ...
        verify(imageOperationsService).applyConversion(eq(Collections.singletonList(Arrays.asList("resize", "(250, 150)"))), eq(entity),
                any(TeeOutputStream.class));
        Thread.sleep(200);
    ...
    public void getParametersTest() throws ImageOperationsException {
        ...
        List<List<List<String>>> expectedParameterLists = Arrays.asList(
                Arrays.asList(Arrays.asList("resize", "(12, 23)"), Arrays.asList("crop", "(10, 10, 20, 20)")),
                Collections.singletonList(Arrays.asList("cropFromCenter", "(10, 10)")),
                Collections.singletonList(Arrays.asList("crop", "(10, 10, 20, 20)")),
                Collections.singletonList(Arrays.asList("resize", "(      200     , 3  )")));
