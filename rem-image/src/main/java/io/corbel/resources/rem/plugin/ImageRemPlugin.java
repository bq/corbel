...
@Component public class ImageRemPlugin extends RemPlugin {
    ...
    private <T extends ImageBaseRem> void registerRem(String remImageIocNames, HttpMethod httpMethod, RemRegistry registry,
            String cacheCollection, Class<T> clazz) {
