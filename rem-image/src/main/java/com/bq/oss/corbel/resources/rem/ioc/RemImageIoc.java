...
@SuppressWarnings("unused") @Configuration @EnableAsync @Import({ConfigurationIoC.class}) public class RemImageIoc {
    ...
    public static Map<String, ImageOperation> getOperations() {
        final AnnotationConfigApplicationContext applicationContext = new AnnotationConfigApplicationContext(RemImageIoc.class);

        return applicationContext
                .getBeansWithAnnotation(ImageOperationName.class)
                .entrySet()
                .stream()
    ...
    public ImageOperationsService getImageOperationsService() {
        return new DefaultImageOperationsService(new DefaultImageOperationsService.IMOperationFactory(),
                new DefaultImageOperationsService.ConvertCmdFactory(), getOperations());
    }
