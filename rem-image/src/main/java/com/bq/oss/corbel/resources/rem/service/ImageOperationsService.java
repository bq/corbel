...
public interface ImageOperationsService {
    ...
    void applyConversion(List<ImageOperationDescription> parameters, InputStream image, OutputStream out, Optional<String> format) throws ImageOperationsException,
