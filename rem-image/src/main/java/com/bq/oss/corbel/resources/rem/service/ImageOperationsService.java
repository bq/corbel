...
public interface ImageOperationsService {
    ...
    void applyConversionWitFormat(List<ImageOperationDescription> parameters, InputStream image, OutputStream out, String format) throws ImageOperationsException,
            InterruptedException, IOException, IM4JavaException;
}
