...
public class ImageDeleteRem extends BaseRem<InputStream> {
    ...
    public ImageDeleteRem(RemService remService, String cacheCollection) {
    ...
    public Response resource(String collection, ResourceId resourceId, RequestParameters<ResourceParameters> requestParameters,
        ...
        restorDeleteRem.collection(cacheCollection, ImagePutRem.getCollectionParametersWithPrefix(resourceId.getId(), requestParameters),
                null, Optional.empty());
