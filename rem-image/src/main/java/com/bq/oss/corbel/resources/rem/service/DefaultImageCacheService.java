...
public class DefaultImageCacheService implements ImageCacheService {
    ...
    @Override
    public InputStream getFromCache(Rem<?> restorRem, ResourceId resourceId, String operationsChain, ImageFormat imageFormat, String collection,
    ...
    @Override
    @Async
    public void saveInCacheAsync(Rem<InputStream> restorPutRem, ResourceId resourceId, String operationsChain, ImageFormat imageFormat, Long newSize,
    ...
    private ResourceId generateId(ResourceId resourceId, String collection, String operationsChain, ImageFormat imageFormat) {
        if(imageFormat.hasFormat()){
