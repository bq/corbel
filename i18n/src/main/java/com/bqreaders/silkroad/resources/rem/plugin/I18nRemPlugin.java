package com.bqreaders.silkroad.resources.rem.plugin;
...
import com.bqreaders.silkroad.resources.rem.i18n.I18nBaseRem;
import com.bqreaders.silkroad.resources.rem.i18n.ioc.I18nIoc;
import com.bqreaders.silkroad.resources.rem.i18n.ioc.I18nRemNames;
...
public class I18nRemPlugin extends RemPlugin {
	...
	protected void register(RemRegistry registry) {
		Map<HttpMethod, I18nBaseRem> rems = ImmutableMap.of(HttpMethod.GET,
				context.getBean(I18nRemNames.I18N_GET, I18nBaseRem.class), HttpMethod.PUT,
				context.getBean(I18nRemNames.I18N_PUT, I18nBaseRem.class), HttpMethod.DELETE,
