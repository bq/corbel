...
public class I18nDeleteRemTest {
	...
	private I18nDeleteRem i18DeleteRem = new I18nDeleteRem();
	...
	public void testDeleteResource() {
		...
		when(remMock.resource(TEST_COLLECTION_TYPE, resourceId, requestParametersMock, Optional.empty())).thenReturn(
				responseMock);

		Response response = i18DeleteRem.resource(TEST_COLLECTION_TYPE, resourceId, requestParametersMock,
				Optional.empty());
