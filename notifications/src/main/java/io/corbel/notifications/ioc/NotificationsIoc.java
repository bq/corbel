...
@Configuration @Import({ConfigurationIoC.class, DropwizardIoc.class, TokenIoc.class, AuthorizationIoc.class, CorsIoc.class,
    ...
    @Bean
    public NotificationConfigResource getNotificationConfigResource(DomainRepository domainRepository,
                                                                    AggregationResultsFactory aggregationResultsFactory) {
        return new NotificationConfigResource(domainRepository, aggregationResultsFactory);
    }
