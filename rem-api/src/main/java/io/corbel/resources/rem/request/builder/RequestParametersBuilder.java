...
public class RequestParametersBuilder<E> {
    ...
    public RequestParameters<E> build() {
        return new RequestParametersImpl<E>(apiParameters, tokenInfo, domainRequest, acceptedMediaTypes, contentLength, params, headers);
    }
    ...
    public RequestParametersBuilder<E> setDoaminRequest(String domain) {
        this.domainRequest = domain;
        return this;
    }
