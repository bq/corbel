...
public class RequestParametersImpl<E> implements RequestParameters<E> {
    ...
    private final String domainRequest;
    private final List<MediaType> acceptedMediaTypes;
    private final MultivaluedMap<String, String> params;
    private final Long contentLength;
    private final MultivaluedMap<String, String> headers;

    public RequestParametersImpl(E apiParameters, TokenInfo tokenInfo, String domainRequest, List<MediaType> acceptedMediaTypes,
            Long contentLength,
