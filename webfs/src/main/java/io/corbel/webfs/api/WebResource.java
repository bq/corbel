...
@Path(ApiVersion.CURRENT + "/path/{domain}") public class WebResource {
    ...
    @GET
    @Path("/{path: .*}")
    public Response getResource(@PathParam("domain") String domain, @PathParam("path") String path, @HeaderParam("Accept") String accept) {
