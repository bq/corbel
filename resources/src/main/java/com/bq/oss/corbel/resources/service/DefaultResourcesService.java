...
public class DefaultResourcesService implements ResourcesService {
    ...
    public DefaultResourcesService(RemService remService, RemEntityTypeResolver remEntityTypeResolver, int defaultPageSize,
                                   int maxPageSize, QueryParser queryParser, AggregationParser aggregationParser, SortParser sortParser, EventBus eventBus) {
    ...
    private QueryParameters getDefaultQueryParameters() {
        return new QueryParameters(defaultPageSize, 0, maxPageSize, Optional.empty(), Optional.empty(), queryParser,
                Optional.empty(), aggregationParser, sortParser, Optional.empty());
    }
